...
> [!CAUTION]
> This project has reached end of life and is no longer maintained by papermc, instead it has been picked up by server owners and plugin dev's like me.
...
> Paper recommends you transition to [Velocity](https://papermc.io/software/velocity). For more information, see the official paper [announcement](https://forums.papermc.io/threads/1088/).  !! AmpCraft and I ARE NOT AFFILIATED with paper mc or any of their projects !!
...
------
 * See the depricated paper API patches [here](BungeeCord-Patches)
